...
**Author**: KAYONGA ELVIS <e.kayonga@alustudent.com>

**Sole Contributor**: KAYONGA ELVIS
...
- **Harmonized sampling rates** across the recorded sessions used in the project
...
- **Baum-Welch Algorithm**: EM-based parameter learning with convergence checking
...
This project was completed and documented by KAYONGA ELVIS as the sole author and contributor.

All major work in this repository, including:
...
was carried out under a single-person ownership model by KAYONGA ELVIS.
